"""LLLM interpreter op-stream, v2 -- table-driven decode, register-only constants.
...
def emit_fetch(a):
    """cw := cells[mi]; belt phase restored."""
    a.BPLOOP('mi', lambda b: b.e('rc', 'sc'))
    a.e('rc'); a.SA('cw'); a.e('sc')
    a.LA('Nn'); a.e('M'); a.LA('mi'); a.e('-', 'N'); a.subk(1)
...
def emit_step(a):
    ...
    a.e('M'); a.LA('t2'); a.e('*', 'M'); a.LA('mi'); a.e('+'); a.SA('mi')
    a.LA('t4'); a.shl(4)
    a.e('M'); a.LA('t3'); a.e('+')
...
def build():
    ...
    emit_fill(a)
    emit_manpos(a)
    a.K(0); a.SA('cw')            # '@' packs to class 0 | colour 0 | dv 0 == 0
    emit_render(a)
