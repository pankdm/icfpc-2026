...
BASE = {'CW': 50, 'ST_OUT': 22, 'FEED_W': 25, 'LOOPR': 31, 'ST_X0': 19, 'D_REP': 30, 'HW_RET': 46, 'HW_TICK': 35, 'HW_SPAWN': 47, 'HW_DIR': 29, 'D_EAT': 30, 'D_NOEAT': 16, 'DRV_OUT': 49, 'DRVX': 4, 'CY0': 8, 'D_HY': 15, 'ST_IN': 23, 'D_HX': 15, 'IN_IN': 45, 'D_COLL': 10, 'CXL': 8}
