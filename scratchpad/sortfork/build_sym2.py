...
room(0, 0, 9, 8)
cells({
    # round entry: read n, BP = n-1, read the first value, drop onto the descent
    (8, 1): "U", (7, 1): "b", (6, 1): "m", (5, 1): "R", (4, 1): "v", (4, 2): ">",
    # lap entry: BP = K-1, read the first value, drop onto the descent
    (7, 2): "m", (6, 2): "R", (5, 2): "v",
    # shared descent: set the running minimum, then east into the greater arm's test
    (5, 3): "M",
