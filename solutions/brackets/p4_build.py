...
def build(save):
    ...
    block(p,12,0,P_W,P_H,P_CELLS,P_MAN)          # P: cols12-18 rows0-8 (touching M east wall)
    p.put(12,9,'>'); p.put(13,9,'^')                    # M->P 2-cell L into P south wall
    p.output_room(15,11)                         # O: cols15-17 rows11-13
    p.pipe([(16,9),(16,10)])                     # P->O
