...
M9_CELLS = [
 (1,1,'>'),(2,1,'s'),(3,1,'v'),(4,1,'<'),(5,1,'<'),(6,1,'0'),(7,1,'<'),
 (1,2,'+'),(3,2,'M'),(4,2,'^'),(5,2,'s'),(7,2,'s'),(8,2,'>'),(9,2,'v'),
 (1,3,'+'),(3,3,'r'),(5,3,'d'),(6,3,'>'),(7,3,'1'),(8,3,'^'),(9,3,'r'),
 (1,4,'^'),(2,4,'+'),(3,4,'X'),(4,4,'+'),(5,4,'M'),(6,4,'X'),(7,4,'^'),(8,4,'^'),(9,4,'M'),
 (3,5,'W'),(5,5,'+'),(6,5,'3'),(8,5,'^'),(9,5,'*'),
 (1,6,'v'),(2,6,'2'),(3,6,'X'),(5,6,'b'),(6,6,'W'),(8,6,'^'),(9,6,'X'),
 (1,7,'N'),(3,7,'s'),(5,7,'W'),(6,7,'/'),
 (1,8,'s'),(3,8,'>'),(4,8,'^'),(5,8,'^'),(6,8,'<'),
