...
CORR = {
    ...
    'SD':  row(11, 28, 29) + col(29, -4, 11) + row(-4, -14, 29) + col(-14, -4, 38) +
           row(38, -14, -12),
    'PP':  row(37, 20, 21) + col(21, 35, 37) + row(35, 21, 47) + col(47, 35, 41) +
           row(41, 40, 47),
    'OUT': row(38, 40, 42),
    ...
    'CTL': col(38, 12, 13) + row(13, 31, 48) + col(48, 13, 53) + row(53, 33, 48) +
           col(33, 52, 53),
}
