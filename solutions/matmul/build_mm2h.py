...
AP_EXIT = col(2, 19, 26) + row(26, 2, 11)
BR_LEAD = col(-8, 42, 46) + row(46, -8, -1) + col(-1, 44, 46) + [(0, 44)]
BR_EXIT = col(0, 55, 56) + row(56, 0, 20) + col(20, 38, 56) + row(38, 15, 20)
...
def build(ap_rect=(2, 2, 15, 18, False), br_rect=(0, 44, 20, 12), verbose=False):
    rt = RT.Router()
    g = RGrid(rt)
