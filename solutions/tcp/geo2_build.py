...
def build_h():
    ...
    L.room(0,CWALL-1, x0+18, BOT-(CWALL-1)+1)
    ...
    # seq pipe: reader south wall (2,RWALL) -> straight down col2 -> collector north wall (2)
    L.pipe([(2,RWALL+1),(2,CWALL-2)])
...
if __name__=='__main__':
    ...
    L.save('/Users/visenbaev/icfpc26/solutions/tcp/tcp-geo2.man')
