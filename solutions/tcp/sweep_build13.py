...
from checker_u import emit_checker_u


def build_full13(CB=3, yr=2, gap=2, cy_checker=8, attach_j=16,
                 lane_gap=2, drain_row_off=1, seq_row_off=8, drain_dx=7, repoll_j=15):
    L = Layout()
    ...
    hints = emit_checker_u(L, cx, cy, seq_j=seq_row_off + yr - cy)
