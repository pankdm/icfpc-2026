...
from checker_u6 import emit_checker_u6


def build_full14(CB=3, yr=2, gap=2, cy_checker=8, attach_j=16,
                 lane_gap=2, drain_row_off=3, seq_row_off=8, drain_dx=7, repoll_j=15):
    L = Layout()
    ...
    hints = emit_checker_u6(L, cx, cy, seq_j=seq_row_off + yr - cy)
    ...
    ocol = cx + 2
    L.output_room(ocol - 1, cy - 5)      # rows cy-5..cy-3
